...
DEFINE
 ...
 NEGTOT=MONEY ARRAY(5)
 ACHAMT=MONEY
 ACHAMTTOT=MONEY ARRAY(5)
 ACHFEE=MONEY
 ACHFEETOT=MONEY ARRAY(5)
 ATMAMT=MONEY
 ATMAMTTOT=MONEY ARRAY(5)
 ATMFEE=MONEY
 ATMFEETOT=MONEY ARRAY(5)
 CHKAMT=MONEY
 CHKAMTTOT=MONEY ARRAY(5)
 CHKFEE=MONEY
 CHKFEETOT=MONEY ARRAY(5)
 OTHER=MONEY
 OTHERTOT=MONEY ARRAY(5)
 RETCKAMT=MONEY
 RETCKAMTTOT=MONEY ARRAY(5)
 RETCKFEE=MONEY
 RETCKFEETOT=MONEY ARRAY(5)
 RETCKCOMM=CHARACTER
 ICOUNT=NUMBER ARRAY(5)
 NEGDATE=DATE
 NEGDAYS=NUMBER
 ACCTNO=CHARACTER
 BEACON=NUMBER
...
SETUP
 ...
 CALL FILEERROR
 FILEOPEN("LETTER","NQ45","WRITE",FN45,FERR)
 CALL FILEERROR
 FILEOPEN("LETTER","NQ300","WRITE",FN300,FERR)
 CALL FILEERROR
                        [todo:"Negative Share Queue - 60 Day"]
 OUTPUTOPEN(OUTPUTDEVREPORT,0,"Negative Share Queue - 45 Day","",OUTPUTCHANNEL1,ERRORTEXT)
END
...
TOTAL
 ...
 HEADING="Negative 45 Days and Over"
 OUTPUTSWITCH(OUTPUTCHANNEL1,ERRORTEXT)               [PRINT 45 DAY TO SEPARATE REPORT]
 FOR I=45 TO 99
  DO
   FILEOPEN("LETTER","NQ45","READ",FN45,FERR)
   CALL FILEERROR
   FILEREADLINE(FN45,FLINE,FERR)
   WHILE FERR=""
    DO
     IF VALUE(SEGMENT(FLINE,35,38))=I OR (I=99 AND VALUE(SEGMENT(FLINE,35,38))>I) THEN
      DO
